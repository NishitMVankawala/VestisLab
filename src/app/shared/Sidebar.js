    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <ul className="nav">
          ...
          <li className={ this.isPathActive('/annotate') ? 'nav-item active' : 'nav-item' }>
            <Link className="nav-link" to="/annotate">
              <span className="menu-title"><Trans>Annotate Demo</Trans></span>
              <i className="mdi mdi-home menu-icon"></i>
            </Link>
          </li>
          <li className={ this.isPathActive('/3d-view') ? 'nav-item active' : 'nav-item' }>
            <Link className="nav-link" to="/3d-view">
              <span className="menu-title"><Trans>3D Viewer</Trans></span>
              <i className="mdi mdi-home menu-icon"></i>
            </Link>
          </li>
          <li className={ this.isPathActive('/extract-frame') ? 'nav-item active' : 'nav-item' }>
            <Link className="nav-link" to="/extract-frame">
              <span className="menu-title"><Trans>Frame Extractor</Trans></span>
              <i className="mdi mdi-home menu-icon"></i>
            </Link>
          </li>
          <li className={ this.isPathActive('/style-input') ? 'nav-item active' : 'nav-item' }>
            <Link className="nav-link" to="/style-input">
              <span className="menu-title"><Trans>Style Input Page</Trans></span>
              <i className="mdi mdi-home menu-icon"></i>
            </Link>
          </li>
